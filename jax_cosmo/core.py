...
class Cosmology:
    def __init__(
        ...
        if Omega_g is None:
            rho_g = (
                4
                * CCLCST.STEFAN_BOLTZMANN_CONSTANT
                / CCLCST.LIGHT_SPEED**3
                * CCLCST.T_CMB**4
            )
    ...
    def tree_unflatten(cls, aux_data, children):
        ...
        Omega_c, Omega_b, h, n_s, sigma8, Omega_k, w0, wa, Omega_g, Omega_r, Neff = (
            children[:11]
        )
        children = list(children[11:]).reverse()
    ...
    @property
    def Omega_de(self):
        return self.Omega - self.Omega_m - self.Omega_g
